...
class WatchedPage extends StatefulWidget {
  ...
  const WatchedPage({required this.watched});
...
class _WatchedPageState extends State<WatchedPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: widget.watched.isNotEmpty
          ? GridView.builder(
        ...
        itemCount: widget.watched.length,
        itemBuilder: (context, index) {
          final movie = widget.watched[index];
